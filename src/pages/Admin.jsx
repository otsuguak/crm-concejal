      ...
      <main className="admin-main">
        ...
        <div className="table-module">
          ...
          <div style={{display: 'flex', gap: '10px', marginBottom: '20px', flexWrap: 'wrap', backgroundColor: '#f8fafc', padding: '15px', borderRadius: '12px', border: '1px solid #e2e8f0'}}>
            ...
            <select value={filtroSLA} onChange={e=>setFiltroSLA(e.target.value)} className="search-bar" style={{flex: '1 1 150px'}}><option value="">⏱️ Todos los Tiempos</option><option value="fila-vencida">🔴 Vencidos</option><option value="fila-alerta">🟡 Por Vencer</option><option value="En Gestión">⚙️ En Gestión</option><option value="atiempo">🟢 A Tiempo</option></select>
